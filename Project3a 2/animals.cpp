...
//delay is a function object, which is the sample we should do, after execute one, new at least a new events
void delay(void) {
...
int main(int argc, char** argv) {
    ...
    new Event(1, &delay);
    Tick::tock();
    // this main loop actually never ends
