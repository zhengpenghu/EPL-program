...
public:
      ...
      virtual Action encounter(const ObjInfo&) = 0;             // return either eat or ignore(just mean want to eat or ignore)
      virtual std::string species_name(void) const = 0;         //done
      virtual std::string player_name(void) const;              //done the same as species_name
