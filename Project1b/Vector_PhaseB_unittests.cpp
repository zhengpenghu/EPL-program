...
TEST(PhaseB1, ReallocCopy)
{
    Foo::reset();
    {
        ...
        x.push_back(x[0]); //1 copy, 2 alive Foo  actually it copy 2 times, which is the problem
       //std::cout<<"Foo::copies is"<<Foo::copies<<std::endl;
        //std::cout<<"Foo::moves is"<<Foo::moves<<std::endl;
